upload_content = [
  ...
  { content = "It's Friday (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "The start of the weekend (created via our dynamic block)", file = "/terraform/test4.txt", executable = true },
]
